...
} from "@/hooks/titan/fb/use-league"
import type { TitanFbLeague } from "@/types"
// UI 组件：表格相关
import {
  Table,
  TableBody,
...
export const LeagueTable = () => {
  ...
  const [editingLeague, setEditingLeague] = useState<TitanFbLeague | null>(null) // 当前编辑的联赛对象
   ...
   */
  const openEditDialog = (league: TitanFbLeague) => {
